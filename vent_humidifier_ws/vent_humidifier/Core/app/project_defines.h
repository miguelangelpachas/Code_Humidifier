...
#define HEAT_HIGH_TEMP_ALARM_DISP_TEMP_UPPER_THRESHOLD_C				43//41.0
#define HEAT_HIGH_TEMP_ALARM_DISP_TEMP_LOWER_THRESHOLD_C				42//40.0

#define HEAT_HIGH_TEMP_ALARM_AIRWAY_TEMP_UPPER_THRESHOLD_C				45//43.0
#define HEAT_HIGH_TEMP_ALARM_AIRWAY_TEMP_LOWER_THRESHOLD_C				44//42.0
...
#define ALARM_UPDATE_PERIOD_MS							100		// DON'T MODIFY!!!

/* Timeout values */
#define ALARM_TOGGLE_TIMEOUT_SEC						1
#define BUZZER_MUTE_TIMEOUT_SEC							120
#define LOW_TEMP_WARNING_TIMEOUT_SEC					25
#define LOW_TEMP_ALARM_TIMEOUT_SEC						600
#define PROBE_MISPLACED_TIMEOUT_SEC						600


#define WATER_OUT_ALARM_STANDBY_TIMEOUT_SEC				300
#define PROBE_MISPLACED_ALARM_STANDBY_TIMEOUT_SEC		180
#define HIGH_TEMP_ALARM_STANDBY_TIMEOUT_SEC				60
#define TEMP_PROBES_CONN_ALARM_STANDBY_TIMEOUT_SEC		0
#define CHAMBER_PROBE_CONN_ALARM_STANDBY_TIMEOUT_SEC	0
#define AIRWAY_PROBE_CONN_ALARM_STANDBY_TIMEOUT_SEC		0
#define HEATER_WIRE_ALARM_STANDBY_TIMEOUT_SEC			0
...
#define CHAMBER_PROBE_MISPLACED_ALARM_FLAG		21
#define AIRWAY_PROBE_MISPLACED_ALARM_FLAG		22
...
#define STANDBY_ALARM_MASK	((1 << TEMPERATURE_PROBE_CONN_ALARM_FLAG) | (1 << CHAMBER_AND_AIRWAY_PROBES_ALARM_FLAG) |\
							(1 << CHAMBER_TEMP_PROBE_ALARM_FLAG) | (1 << AIRWAY_TEMP_PROBE_ALARM_FLAG) | (1 << HEATER_WIRE_ALARM_FLAG) |\
							(1 << WATER_OUT_ALARM_FLAG) | (1 << HIGH_TEMP_ALARM_FLAG))

#define QUICK_FIX_ALARM_MASK	((1 << TEMPERATURE_PROBE_CONN_ALARM_FLAG) | (1 << CHAMBER_TEMP_PROBE_ALARM_FLAG) |\
								(1 << AIRWAY_TEMP_PROBE_ALARM_FLAG) | (1 << HEATER_WIRE_ALARM_FLAG) | (1 << HIGH_TEMP_ALARM_FLAG))

#define SLOW_FIX_ALARM_MASK		((1 << CHAMBER_AND_AIRWAY_PROBES_ALARM_FLAG) | (1 << WATER_OUT_ALARM_FLAG) | (1 << LOW_TEMP_ALARM_FLAG))
